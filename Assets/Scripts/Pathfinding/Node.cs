...
public class Node : IHeapItem<Node>
{
    ...
    public Node(bool _walkable, bool _isMud, bool _isWater, Vector2 _worldPos, int _gridX, int _gridY)
    {
        walkable = _walkable;
        isMud = _isMud;
        isWater = _isWater;
    ...
    public Node Clone()
    {
        return new Node(walkable, isMud, isWater, worldPosition, gridX, gridY);
    }
